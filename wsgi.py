...
class Hello(object):
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100409.1759: *3* drawspur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100409.1829: *3* drawspuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100409.1831: *3* spur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428100409.1833: *3* spuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
